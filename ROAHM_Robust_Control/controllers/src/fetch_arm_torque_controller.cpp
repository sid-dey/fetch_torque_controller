// #include <iostream>
#include "../../classical_rnea_fetch_utils.cpp"
#include<cmath>
#include<vector>
...
class FetchArmTorqueController {
    ...
    */
    Eigen::VectorXd update(Eigen::VectorXd q, Eigen::VectorXd qd, Eigen::VectorXd q_des, 
        ...
        Eigen::VectorXd r = qd_des - qd + Kr_*(q_des - q);

        //Step 2, calculate nominal torque from passivity RNEA
        Eigen::VectorXd u1 = rnea(q, qd, qd_aux, qdd_aux, true);
        return u1;
    }
