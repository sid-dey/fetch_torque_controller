...
Eigen::Matrix<double, 7, 1> rnea(Eigen::VectorXd q, Eigen::VectorXd qd, Eigen::VectorXd q_aux_d, Eigen::VectorXd qdd, bool use_gravity) {
    // function u = rnea(q, qd, q_aux_d, qdd, use_gravity, robot_params)


    /****************************** manually adding robot params **************************/
